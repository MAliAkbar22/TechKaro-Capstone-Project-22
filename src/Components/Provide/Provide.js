        ...
        <div className="container">
            <div className="provide-container">
                ...
                <div className="provide-right">
                    ...
                    <h2>Resolves the disease by making face-to-face contact with patients on the telehealth platform.</h2>
                ...
                <div className="percentage">
                    <span className="blue">80%</span><p>Of patients are interested in using telemedicine</p>
                </div>
                <div className="percentage">
                    <span className="black">90%</span><p>Of patients are satisfied with the telehealth experience</p>
                </div>
                <div className="percentage">
                    <span className="black">40%</span><p>Of patients use telemedicine due to short travel time</p>
                </div>    
                </div>
            </div>
        </div>
